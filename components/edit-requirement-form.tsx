...
export default function EditRequirementForm({ requirement, pos, onSubmit, onClose }: EditRequirementFormProps) {
  ...
  const [selectedItems, setSelectedItems] = useState<any[]>(requirement.selectedItems || [])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      selectedItems: selectedItems.map((item) => ({
        ...
        quantitySupplied: item.quantitySupplied || 0,
        unit: item.unit,
      })),
    })
  }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle>Edit Material Requirement</CardTitle>
            <CardDescription>Modify the material requirement details</CardDescription>
          </div>
